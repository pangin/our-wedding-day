...
export const wedding = {
  ...
  images: {
    ...
    gallery: [
      {
        id: 'bench',
        src: cloudinaryImage('wedding-2026/iqjox53rjk4ax7oa3avb', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '벤치에 함께 앉은 신랑 신부',
        caption: '함께한 순간',
      },
      {
        id: 'closeup',
        src: cloudinaryImage('wedding-2026/vh5vh7tlm9qqzmilfe2m', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '마주 보고 환하게 웃는 신랑 신부',
        caption: '마주한 미소',
      },
      {
        id: 'portrait',
        src: cloudinaryImage('wedding-2026/oiyo6hqj0ksvc6jzbext', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '부케를 함께 든 신랑 신부 포트레이트',
        caption: '두 사람',
      },
      {
        id: 'sunlight',
        src: cloudinaryImage('wedding-2026/fycadx9dlxkp7tyqh1ns', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '햇살 아래 다정하게 안긴 신랑 신부',
        caption: '햇살 아래',
      },
      {
        id: 'cheek',
        src: cloudinaryImage('wedding-2026/tbocy1ycu9frjg2pldsa', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '서로 가까이서 바라보는 신랑 신부',
        caption: '다정한 눈빛',
      },
      {
        id: 'veil',
        src: cloudinaryImage('wedding-2026/tlbmdtbz0nldzkmpa9w9', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '베일 아래 신랑 신부',
        caption: '함께 걷는 길',
      },
      {
        id: 'sunny',
        src: cloudinaryImage('wedding-2026/hcyzevnmc4hadruvnv3q', 'f_auto,q_auto,w_1600,h_2000,c_fill'),
        alt: '햇살 가득한 야외 신랑 신부',
        caption: '눈부신 봄날',
      },
